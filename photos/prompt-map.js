...
const MANIFEST = [
  ...
  { key:'theorie-4_verkeersbrigadier', title:'Verkeersbrigadier', prompt:'Front view across a Dutch zebra crossing: the red learner car is fully stopped with a broad visible asphalt gap before the first stripe, while two children walk laterally within the crossing and a fluorescent-clad guard holds a stop paddle toward Dandan.' },
