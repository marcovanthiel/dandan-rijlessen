---
titel: "Modül 2: Türkçe ders materyali (NL-TR)"
aard: ÖZGÜN ders materyali, kamuya açık trafik kuralları/tekniğe dayalı
opzet: Hollandaca başlık + özgün ders metni; terminoloji sözlüğe uyar
---

# Modül 2: Basit trafik durumları · Module 2: Eenvoudige verkeerssituaties

> Bu modül, birinci modülde öğrenilen hareketleri basit trafik durumlarında uygular ve
> "tahmin, değerlendirme, karar" alıştırmasına başlar. Başlamadan önce teori sınavını (teori
> sınavı) geçmiş olmanız önerilir. Modül sonunda ikinci ara test yapılır.

### Stap 19 · Kalkış ve durma (Wegrijden en stoppen)
Yalnızca başka trafiği tehlikeye atmadan ve engellemeden kalkabilir veya durabilirsiniz; durumun
tümünü değerlendirip zamanlamayı ve hızı ona göre ayarlayın. Park yerinden kalkış özel bir manevradır:
gözlem (öne, aynalara, dönüp bakma), boş alanı değerlendirme, yaklaşan araçlara **yol vermek**.
Sağda dururken iç dikiz aynasına/öne/sol dış aynaya/sol omza bakın; solda durmak daha zordur ("öteki
tarafta" oturursunuz), sağ omza bakıp mutlaka dönüp bakın. Sinyali çok erken vermeyin (yanlış
...
kazandırır. Virajda merkezkaç kuvveti vardır; "spiral etkisi" virajı giderek keskinleştirir, yol
eğimi (kamber) yardımcı olur, bunların hepsi için önceden yavaşlayın. Gereken boşluk yol tipine,
şerit sayısına, yüzeye, yere (şehir içi/konut bölgesi), diğer aracın hızına ve havaya bağlıdır.
...
yine sola çeker), buna hazır olun. Her araç bankete güvenle giremez (ağır kamyon). Zamanında kaçınmak
...
(voorrang) olsa bile dikkatli yaklaşın. Bazen yol vermesi gerekene önce geçme fırsatı vermek akış ve
güvenlik için daha iyidir; dönen kamyona/otobüse yer bırakın. Levhaları tanıyın: öncelikli yol/öncelikli
kavşak levhası (sizde öncelik var); B6 yol ver (üçgen yol ver çizgisi); B7 dur ve yol ver (dur çizgisi);
levha yoksa eşdeğer kavşak (sağdan gelen önce; toprak yol asfalt yola yol verir; dönel kavşak/tramvay
...
düzeltin (arkadan çarpıldığında karşı şeride fırlamayı önlemek için). Sıra: gözlem, güvenlik boşluğu,
aynalara ve kör noktaya bak, **sinyal ver** (erken), **şeride gir** (sağa dönüşte sağa; sola dönüşte
orta çizgiye; tek yönde tamamen sola olabilir), kavşağa gir, yol ver. Ayrı bisiklet yolu/servis yolu/
...
debriyaj). Dururken direksiyonu düzeltin, bordüre çok yaklaşmayın; R vitesine alın. Gözlem: arka camdan
...
değerlendirin; bu özel bir manevradır. Yol kenarına ileri park: alan en az iki araç boyu olsun, hedef
aracın yanında yaklaşık 50 santimetrede dur, vitese al, kör noktayı gözle. Yol kenarına geri park: biraz
öne git (0,5 metre), direksiyonu düzelt, R vitesine al, gözle. Geri park: manevra için biraz ileri geçin,
90 derece dönüş yapabilmek için hafif "muz biçiminde" eğik durabilirsiniz, arka cam ve aynalar üzerinden
...
yapın. Yavaş git, direksiyonu hızlı çevir. İleri giderken sol ön tekerlek bordüre neredeyse değene kadar
