---
titel: "Módulo 4: comportamento de condução responsável, material didático em português (NL-PT)"
...
# Módulo 4: comportamento de condução responsável · Module 4: Verantwoord (rij)gedrag

> Aplica com flexibilidade todos os passos aprendidos num percurso conduzido de forma autónoma; o foco está
> na atitude e na mentalidade: conduzir de forma defensiva, cívica e responsável. Depois deste módulo já te
> preparas para o exame prático do CBR; o examinador espera que resolvas as situações por ti, mesmo que
> cometas um pequeno erro.

### Stap 40 · Condições difíceis (Moeilijke omstandigheden)
A luz e o tempo afetam a observação. Ao entardecer: a luz enfraquece, as cores esbatem-se e o sol baixo
encandeia, por isso abranda, acende as luzes e atenção a quem circula sem luzes e ao reflexo fraco dos sinais.
De noite: vês menos e também és menos visível; os olhos têm de se adaptar sem parar (luz ambiente/luzes em
sentido contrário), por isso não fixes as luzes dos carros que vêm em frente, orienta-te pelos postes da
berma, pelos refletores, pelas marcas no pavimento e pelos sinais, e usa os médios para seres mais visível;
conta com pessoas que veem mal. Há ainda os túneis (mudança brusca de luz), os cruzamentos movimentados da
...
de meio. Uma boa preparação reduz a poluição desnecessária. O navegador serve de apoio (eficaz fora da cidade;
...
e deixa o carro rolar na mudança mais alta possível. Poupa combustível (5 a 10%): verifica a pressão dos
pneus todos os meses (com o carro frio), não uses barras/caixa de tejadilho a mais (podem aumentar o consumo
cerca de 30%), reduz o peso e a resistência do ar. Na caixa automática: influencia o momento da mudança com a
...
eficazes; mantém sempre uma visão de conjunto, sabe antecipar e desfazer os erros dos outros. Perigos
previsíveis (por exemplo, o sol baixo a bater no teu espelho significa que os carros em sentido contrário vão
...
tens de a concluir (exceto em emergência), desde que tenhas feito bem os preparativos. Por exemplo: ao passares
...
força); resolve isso a recuperar espaço de segurança, recuperando visibilidade e tempo de reação. Condução
cívica: ajuda os outros de bom grado quando é preciso, mesmo que tenham errado; respeita os interesses dos
outros e assume a tua responsabilidade. Cansaço: descansa bem antes de ir para a estrada, nas viagens longas
para 15 minutos a cada 2 horas e atenção à postura/à pega. Álcool/droga/medicamentos: conduzir sob o seu
